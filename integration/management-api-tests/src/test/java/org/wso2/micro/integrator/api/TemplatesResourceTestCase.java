...
public class TemplatesResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveTemplates() throws IOException {
        ...
        Assert.assertTrue(jsonResponse.get("list").toString().contains("AbcTemplate"));
        Assert.assertTrue(jsonResponse.get("list").toString().contains("testSequenceTemplate"));
    }
