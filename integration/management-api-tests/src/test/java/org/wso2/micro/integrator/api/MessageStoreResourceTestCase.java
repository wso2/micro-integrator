...
public class MessageStoreResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveSearchedMessageStores() throws IOException {
        ...
        String responsePayload = sendHttpRequestAndGetPayload("HelloMessage");
        JSONObject jsonResponse = new JSONObject(responsePayload);
    ...
    private String sendHttpRequestAndGetPayload(String searchKey) throws IOException {
        ...
        String endpoint = "https://" + hostName + ":" + (DEFAULT_INTERNAL_API_HTTPS_PORT + portOffset) + "/management/message-stores";
        if (searchKey != null) {
