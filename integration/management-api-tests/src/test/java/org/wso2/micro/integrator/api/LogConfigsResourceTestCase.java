...
public class LogConfigsResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveLogConfigs() throws IOException {
        ...
        Assert.assertEquals(jsonResponse.get("count"), 80);
        Assert.assertTrue(jsonResponse.get("list").toString().contains("axis2Deployment"));
        Assert.assertTrue(jsonResponse.get("list").toString().contains("Axis2SynapseController"));
    }
    ...
    public void retrieveSearchedLogConfigs() throws IOException {
        ...
        Assert.assertTrue(jsonResponse.get("list").toString().contains("AUDIT_LOG"));
    }
