...
public class ApiResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveAPIs() throws IOException {
        ...
        Assert.assertTrue(jsonResponse.get("list").toString().contains("AbcRestApi"));
        Assert.assertTrue(jsonResponse.get("list").toString().contains("HelloRestApi"));
    }
