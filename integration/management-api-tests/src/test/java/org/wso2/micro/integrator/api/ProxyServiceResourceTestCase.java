...
public class ProxyServiceResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveProxyServices() throws IOException {
        ...
        Assert.assertTrue(jsonResponse.get("list").toString().contains("AbcProxyService"));
        Assert.assertTrue(jsonResponse.get("list").toString().contains("HelloProxyService"));
        Assert.assertTrue(jsonResponse.get("list").toString().contains("testProxy"));
    }
    ...
    public void retrieveSearchedProxyServices() throws IOException {
        ...
        String responsePayload = sendHttpRequestAndGetPayload("HelloProxy");
        JSONObject jsonResponse = new JSONObject(responsePayload);
    ...
    private String sendHttpRequestAndGetPayload(String searchKey) throws IOException {
        ...
        String endpoint = "https://" + hostName + ":" + (DEFAULT_INTERNAL_API_HTTPS_PORT + portOffset) + "/management/proxy-services";
        if (searchKey != null) {
