...
public class ConnectorResourceTestCase extends ESBIntegrationTest {
    ...
    public void retrieveConnectors() throws IOException {
        ...
        Assert.assertTrue(jsonResponse.get("list").toString().contains("CSV"), "Assert failed " +
    ...
    public void retrieveSearchedConnectors() throws IOException {
        ...
        String responsePayload = sendHttpRequestAndGetPayload("csv");
        JSONObject jsonResponse = new JSONObject(responsePayload);
    ...
    private String sendHttpRequestAndGetPayload(String searchKey) throws IOException {
        ...
        String endpoint = "https://" + hostName + ":" + (DEFAULT_INTERNAL_API_HTTPS_PORT + portOffset) + "/management/connectors";
        if (searchKey != null) {
