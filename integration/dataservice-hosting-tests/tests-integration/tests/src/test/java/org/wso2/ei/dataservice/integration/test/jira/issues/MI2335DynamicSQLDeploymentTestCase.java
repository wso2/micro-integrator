...
/*
 * This is related to https://github.com/wso2/micro-integrator/issues/2335
 */
public class MI2335DynamicSQLDeploymentTestCase extends DSSIntegrationTest {
    ...
    public void testDeployService() throws IOException {
        ...
        Assert.assertEquals(response.getStatusLine().getStatusCode(), 200, "Error in deploying a data service with" +
                "dynamic query");
    }
}
