...
public class JMXStatisticsTestCase extends DSSIntegrationTest {
    ...
    public void testVerifyServiceAttributesViaJMX() throws Exception {
        ...
        assertTrue(jmxClient.getAttribute("DataServiceDescriptorPath").toString().
                contains("repository" + File.separator + "deployment" + File.separator + "server" + File.separator
    ...
    public void testVerifyServiceOperationsViaJMX() throws Exception {
        ...
        assertTrue(jmxClient.invoke("getConfigTypeFromId", new Object[] { "GSpreadDataSource" })
                .equals("GDATA_SPREADSHEET"));
        assertTrue(
                jmxClient.invoke("isDatabaseConnectionStatsAvailable", new Object[] { "GSpreadDataSource" }).toString()
                        .equals("false"));
