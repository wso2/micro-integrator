...
public class DS954UseExcelFromRegistryTestCase extends DSSIntegrationTest {
    ...
    public void serviceDeployment() throws Exception {
        ...
        resourceAdmin.addResource("/_system/governance/excel/Products.xls", "application/vnd.ms-excel", "",
                new DataHandler(
                        new URL("file:///" + getResourceLocation() + File.separator + "resources" + File.separator
                                + "Products.xls")));
        deployService(serviceName, createArtifact(
                getResourceLocation() + File.separator + "dbs" + File.separator + "excel" + File.separator + serviceName
                        + ".dbs", sqlFileLis));
