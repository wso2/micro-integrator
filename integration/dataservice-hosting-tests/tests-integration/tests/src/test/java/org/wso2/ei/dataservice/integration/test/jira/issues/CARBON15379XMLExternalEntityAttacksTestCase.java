...
public class CARBON15379XMLExternalEntityAttacksTestCase extends DSSIntegrationTest {
    ...
    public void xmlExternalEntityAttackOnTestDataSourceTest() throws Exception {
        ...
        WSDataSourceMetaInfo dataSourceWithoutAttack = createWSDataSourceMetaInfo("TestDatasource1", xmlWithoutAttack,
                "RDBMS");
        ...
        WSDataSourceMetaInfo dataSourceWithAttack = createWSDataSourceMetaInfo("TestDatasource2", xmlWithAttack,
                "RDBMS");
    ...
    public void xmlExternalEntityAttackOnAddDataSourceTest() throws Exception {
        ...
        WSDataSourceMetaInfo dataSourceWithoutAttack = createWSDataSourceMetaInfo("TestDatasource3", xmlWithoutAttack,
                "RDBMS");
        try {
        ...
        WSDataSourceMetaInfo dataSourceWithAttack = createWSDataSourceMetaInfo("TestDatasource4", xmlWithAttack,
                "RDBMS");
        try {
            nDataSourceAdminServiceClient.addDataSource(
                    dataSourceWithAttack); //this fails, but it doesn't throw an exception, needs to check the reason.
