...
public class EI1222JSONSecuredServiceWithXMLCharacterTestCase extends DSSIntegrationTest {
    ...
    private void copyXMLInputFactoryPropertiesFile() throws Exception {
        ...
        String propertiesSrcLocation =
                getResourceLocation() + File.separator + "resources" + File.separator + INPUT_FACTORY_PROPERTIES_FILE;
        try {
            FileUtils.copyFileToDirectory(new File(propertiesSrcLocation), new File(carbonHome));
    ...
    public void clean() throws Exception {
        ...
        FileUtils.forceDelete(new File(
                System.getProperty(ServerConstants.CARBON_HOME) + File.separator + INPUT_FACTORY_PROPERTIES_FILE));
        // restart server
