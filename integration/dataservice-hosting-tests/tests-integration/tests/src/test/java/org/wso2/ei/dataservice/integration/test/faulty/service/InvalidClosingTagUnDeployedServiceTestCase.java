...
public class InvalidClosingTagUnDeployedServiceTestCase extends DSSIntegrationTest {
    ...
    @BeforeClass(alwaysRun = true) public void serviceDeployment() throws Exception {
        ...
        String serviceFilePath =
                resourceFileLocation + File.separator + "dbs" + File.separator + "rdbms" + File.separator + "MySql"
                        + File.separator + serviceFile;

        createArtifact(serviceFilePath, getSqlScript());
        dataServiceAdminClient = new DataServiceFileUploaderClient(dssContext.getContextUrls().getBackEndUrl(),
                sessionCookie);
