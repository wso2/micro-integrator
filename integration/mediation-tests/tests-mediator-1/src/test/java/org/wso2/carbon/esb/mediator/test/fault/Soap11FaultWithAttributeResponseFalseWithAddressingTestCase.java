...
public class Soap11FaultWithAttributeResponseFalseWithAddressingTestCase extends ESBIntegrationTest {
    ...
    public void testSOAP11FaultAttributeResponseFalseWithAddressing() throws AxisFault {
        try {
            String proxyServiceName = "Soap11FaultWithAttributeResponseFalseWithAddressingTestCaseProxy";
            ...
            assertEquals(expected.getMessage(), "Soap11FaultWithAttributeResponseFalseWithAddressingTestCase",
