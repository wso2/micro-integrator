...
public class ProtocolReWriteTest extends ESBIntegrationTest {
    ...
    @Test(groups = {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("urlRewriteReplaceProtocolTestProxy"), addUrl,
                        "IBM");
    ...
    @DataProvider(name = "addressingUrl") public Object[][] addressingUrl() throws XPathExpressionException {
        return new Object[][] { { getBackEndServiceUrl(ESBTestConstant.SIMPLE_STOCK_QUOTE_SERVICE) },
