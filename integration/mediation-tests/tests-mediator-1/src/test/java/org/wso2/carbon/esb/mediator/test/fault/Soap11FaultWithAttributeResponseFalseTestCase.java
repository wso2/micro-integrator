...
public class Soap11FaultWithAttributeResponseFalseTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true) public void uploadSynapseConfig() throws Exception {
        ...
        loadESBConfigurationFromClasspath(
                "/artifacts/ESB/mediatorconfig/fault/soap11_fault_set_response_false_synapse.xml");
    }

    @Test(groups = {
            "wso2.esb" }, description = "Creating SOAP1.1 fault messages as Response false") public void testSOAP11FaultAttributeResponseFalse()
            throws AxisFault {
        try {
