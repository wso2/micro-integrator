...
public class Soap12FaultWithAttributeResponseTrueTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true) public void uploadSynapseConfig() throws Exception {
        ...
        loadESBConfigurationFromClasspath(
                "/artifacts/ESB/mediatorconfig/fault/soap12_fault_set_response_true_synapse.xml");
    }

    @Test(groups = {
            "wso2.esb" }, description = "Creating SOAP1.2 fault messages as Response true") public void testSOAP12FaultAttributeResponseTrue()
            throws AxisFault {
        try {
            ...
            assertEquals(expected.getReason(), "Custom ERROR Message - Soap12FaultWithAttributeResponseTrueTestCase",
                    "Custom ERROR Message mismatched");
