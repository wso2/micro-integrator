...
public class Soap12FaultCodeMustUnderstandTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true) public void uploadSynapseConfig() throws Exception {
        ...
        loadESBConfigurationFromClasspath(
                "/artifacts/ESB/mediatorconfig/fault/soap12_fault_code_MustUnderstand_synapse.xml");
    }

    @Test(groups = {
            "wso2.esb" }, description = "Creating SOAP1.2 fault code MustUnderstand") public void testSOAP12FaultCodeMustUnderstand()
            throws AxisFault {
