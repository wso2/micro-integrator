...
public class RuleSourceGivenWrappedInCDATATest extends ESBIntegrationTest {
    ...
    private OMElement sendRequest(String symbol) throws AxisFault {
        return axis2Client.sendSimpleStockQuoteRequest(getProxyServiceURLHttp("RuleSourceGivenWrappedInCDATATestProxy"), null, symbol);
    }
}
