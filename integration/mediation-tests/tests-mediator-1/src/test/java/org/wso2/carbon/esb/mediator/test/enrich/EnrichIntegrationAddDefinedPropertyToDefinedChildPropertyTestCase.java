...
public class EnrichIntegrationAddDefinedPropertyToDefinedChildPropertyTestCase extends ESBIntegrationTest {
    ...
    public void testEnrichMediator() throws Exception {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("enrichAddChildFromPropertyTestProxy"), null,
                        "WSO2");

        assertNotNull(response, "Response message null");
        OMElement newChild = response.getFirstChildWithName(new QName("http://services.samples", "NewChild"));
