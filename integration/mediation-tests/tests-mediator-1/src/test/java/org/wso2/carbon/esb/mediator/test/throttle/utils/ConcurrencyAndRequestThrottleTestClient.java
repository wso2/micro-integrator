...
public class ConcurrencyAndRequestThrottleTestClient implements Runnable {
    ...
    public ConcurrencyAndRequestThrottleTestClient(String proxyServiceURL, List list,
            ThrottleTestCounter ConcurrencyThrottleCounter, ThrottleTestCounter requestThrottleCounter,
