...
public class EnrichIntegrationBodyToChildOfBodyTestCase extends ESBIntegrationTest {
    ...
    public void testEnrichMediator() throws Exception {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("enrichBodyToChildOfBodyTestProxy"), null, "WSO2");

        assertNotNull(response, "Response message null");

        OMElement requestBody = response.getFirstChildWithName(new QName("http://services.samples", "getQuote"));
