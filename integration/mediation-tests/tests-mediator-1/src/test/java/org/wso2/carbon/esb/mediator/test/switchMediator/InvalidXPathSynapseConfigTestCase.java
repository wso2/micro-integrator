...
public class InvalidXPathSynapseConfigTestCase extends ESBIntegrationTest {
    ...
    public void uploadingInvalidXPathSynapse() throws Exception {
        ...
        try {
            ...
            assertTrue("Error Message mismatched.not contain message 'Error while updating the Synapse configuration'",
                    expected.getReason().contains("Error while updating the Synapse configuration"));
        }
    }
