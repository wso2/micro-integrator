...
public class EnrichIntegrationMultipleNodeReplace extends ESBIntegrationTest {
    ...
    public void testEnrichMediator() throws Exception {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("enrichMultipleNodeReplaceTestProxy"), null,
                        "WSO2");
        ...
        OMElement symbolElement = response.getFirstChildWithName(new QName("http://services.samples/xsd", "symbol"));
