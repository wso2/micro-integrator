...
public class Soap11FaultCodeVersionMismatchedTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true) public void uploadSynapseConfig() throws Exception {
        ...
        loadESBConfigurationFromClasspath(
                "/artifacts/ESB/mediatorconfig/fault/soap11_fault_code_VersionMismatch_synapse.xml");
    }

    @Test(groups = {
            "wso2.esb" }, description = "Creating SOAP1.1 fault code VersionMismatched") public void testSOAP11FaultCodeVersionMismatched()
            throws AxisFault {
        try {
