...
public class EnrichIntegrationAddBodyToChildXpathTestCase extends ESBIntegrationTest {
    ...
    public void testEnrichMediator() throws Exception {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("enrichAddBodyToChildTestProxy"), null, "WSO2");
        assertNotNull(response, "Response message null");

        OMElement returnTag = response.getFirstElement();
        OMElement symbolResponse = returnTag
                .getFirstChildWithName(new QName("http://services.samples", "getQuoteResponse")).getFirstElement();
