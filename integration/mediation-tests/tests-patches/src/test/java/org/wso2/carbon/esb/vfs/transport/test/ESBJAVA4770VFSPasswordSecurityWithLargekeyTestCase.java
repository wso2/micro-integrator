...
public class ESBJAVA4770VFSPasswordSecurityWithLargekeyTestCase extends ESBIntegrationTest {
    ...
    public void runFTPServer() throws Exception {
        ...
        super.init();
        File jksFile = new File(
                getClass().getResource("/artifacts/ESB/synapseconfig/vfsTransport" + "/ESBJAVA4770/vfsKeystore.jks")
                        .getPath());

        File destinationJks = Paths
                .get(CarbonBaseUtils.getCarbonHome(), "repository", "resources", "security", "vfsKeystore.jks")
                .toFile();
