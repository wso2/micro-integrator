...
public class ESBJAVA3714JMXPauseJMSListener extends ESBIntegrationTest {
    ...
    public void testJMSPause() throws Exception {
        ...
        Set<ObjectInstance> objSet = mbsc
                .queryMBeans(new ObjectName("org.apache.axis2:Type=Transport,ConnectorName=jms-listener-*"), null);
...
//            esbUtils.deleteProxyService(contextUrls.getBackEndUrl(), getSessionCookie(), proxyName);
    ...
    private String getJMSProxy() {
        return "    <proxy xmlns=\"http://ws.apache.org/ns/synapse\" name=\"" + PROXY_NAME
                + "\" transports=\"jms\" startOnLoad=\"true\" trace=\"disable\">\n" + "        <description/>\n"
                + "        <target>\n" + "            <inSequence>\n"
