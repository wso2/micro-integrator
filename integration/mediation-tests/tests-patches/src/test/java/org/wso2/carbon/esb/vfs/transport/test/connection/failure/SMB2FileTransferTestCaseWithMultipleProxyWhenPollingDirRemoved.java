 ...
 */
public class SMB2FileTransferTestCaseWithMultipleProxyWhenPollingDirRemoved extends ESBIntegrationTest {

    private static final Log LOGGER = LogFactory.getLog(SMB2FileTransferTestCaseWithMultipleProxyWhenPollingDirRemoved.class);
    ...
    @Test(groups = "wso2.esb", description = "SMB2 Multiple proxy file transfer test when dir removed")
    public void multipleProxyFileTransferTestWhenDirRemoved()
