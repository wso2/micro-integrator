...
public class ESBJAVA2907TestCase extends ESBIntegrationTest {
    ...
    @Test(groups = "wso2.esb",
          description = "Test adding OMElements as properties when saving messages to the MessageStore",
          enabled = false)
    public void testAddingOMElementPropertyToMessageStore() throws Exception {
        ...
        Assert.assertTrue(carbonLogReader.checkForLog(GET_QUOTE_REQUEST_BODY, DEFAULT_TIMEOUT),
                          "OMElement is not saved to the message store");
