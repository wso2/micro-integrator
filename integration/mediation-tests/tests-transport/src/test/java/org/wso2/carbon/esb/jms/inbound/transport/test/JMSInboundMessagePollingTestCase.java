        ...
        try {
            ...
            for (int i = 0; i < 3; i++) {
                sender.pushMessage("<?xml version='1.0' encoding='UTF-8'?>"
                        ...
                        + "            <xsd:quantity>2000</xsd:quantity>" + "            <xsd:symbol>WSO2</xsd:symbol>"
                        + "         </ser:order>" + "      </ser:placeOrder>" + "   </soapenv:Body>"
                        + "</soapenv:Envelope>");
...
/**
    ...
    public void testDeploymentOrder() throws Exception {
        ...
        carbonAppUploaderClient.uploadCarbonAppArtifact(carFileName, new DataHandler(
