...
public class TemplateAdminService extends ESBIntegrationTest {
    ...
    private static final String endpointTmpl1 =
            "<template xmlns=\"http://ws.apache.org/ns/synapse\" name= \"SampleEndpointTemplate\">"
                    ...
                    + "<address uri=\"https://localhost:9000/services/SimpleStockQuoteService\">" + "</address>"
                    + "</endpoint>" + "</template>";
    private static final String endpointTmpl2 =
            "<template xmlns=\"http://ws.apache.org/ns/synapse\" name= \"SampleEndpointTemplate\">"
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template creation service", priority = 1) public void testCreateTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template list service", priority = 2) public void testGetTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template save service", priority = 3) public void testUpdateTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template enable statistics", priority = 4) public void testEnableStatisticsTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template disable statistics", priority = 5) public void testDisableStatisticsTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template enable tracing", priority = 6) public void testEnableTracingTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template disable tracing", priority = 7) public void testDisableTracingTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test template delete service", priority = 8) public void testDeleteTemplate()
            throws Exception {
        int prevCount = templateAdmin.getTemplatesCount();
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test list invalid template", priority = 9) public void testGetInvalidTemplate()
            throws Exception {
        try {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test dynamic template creation service", priority = 10) public void testCreateDynamicTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test dynamic template list service", priority = 11) public void testGetDynamicTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test dynamic template creation service", priority = 12) public void testUpdateDynamicTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test endpoint template creation service", priority = 13) public void testCreateEndpointTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test endpoint template list service", priority = 14) public void testListEndpointTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test endpoint template update service", priority = 15) public void testUpdateEndpointTemplate()
            throws Exception {
    ...
    @Test(groups = {
            "wso2.esb" }, description = "Test listing invalid endpoint template", priority = 14) public void testListInvalidEndpointTemplate()
            throws Exception {
        try {
