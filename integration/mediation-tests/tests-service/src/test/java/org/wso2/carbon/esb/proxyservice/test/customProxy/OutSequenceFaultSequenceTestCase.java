...
public class OutSequenceFaultSequenceTestCase extends ESBIntegrationTest {
    ...
    private void uploadResourcesToConfigRegistry() throws Exception {
        ...
        resourceAdminServiceStub.addCollection("/_system/config/", "sequence", "", "Contains test sequence files");

        resourceAdminServiceStub
                .addResource("/_system/config/sequence/out_sequence.xml", "application/vnd.wso2.sequence",
                        "application/vnd.wso2.sequence files", new DataHandler(
        ...
        resourceAdminServiceStub
                .addResource("/_system/config/sequence/fault_sequence.xml", "application/vnd.wso2.sequence",
                        "application/vnd.wso2.sequence files", new DataHandler(
                                new URL("file:///" + getESBResourceLocation()
