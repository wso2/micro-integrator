...
public class ProxyServiceEnablingHTTPSTestCase extends ESBIntegrationTest {
    ...
    @Test(groups = "wso2.esb", description = "- Transformer proxy" + "- Proxy service enabling only https")
    public void testTransformerProxy() throws Exception {

        OMElement response = axis2Client
                .sendCustomQuoteRequest(getProxyServiceURLHttps("enableHttpsTransformerProxy"), null, "WSO2");
