...
public class ProxyServiceEndpointBindingsTestCase extends ESBIntegrationTest {
    ...
    public void testHttpSoap11EndpointBinding() throws Exception {
        ...
        assertEquals(symbol, "HttpSoap11Endpoint",
    ...
    private String getProxyServiceHttp11BindingURL(String proxyServiceName) throws XPathExpressionException {
        return "http://" + context.getInstance().getHosts().get("default") + ":" + context.getInstance().getPorts()
                .get("nhttp") + "/services/" + proxyServiceName + "." + proxyServiceName + "HttpSoap11Endpoint";
    }

    private String getProxyServiceHttps11BindingURL(String proxyServiceName) throws XPathExpressionException {
        return "https://" + context.getInstance().getHosts().get("default") + ":" + context.getInstance().getPorts()
                .get("nhttps") + "/services/" + proxyServiceName + "." + proxyServiceName + "HttpsSoap11Endpoint";
    }
}
