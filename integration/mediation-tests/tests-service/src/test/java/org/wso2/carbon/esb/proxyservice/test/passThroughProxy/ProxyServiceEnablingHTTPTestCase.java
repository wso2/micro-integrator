...
public class ProxyServiceEnablingHTTPTestCase extends ESBIntegrationTest {
    ...
    @Test(groups = "wso2.esb", description = "- Pass through proxy" + "- Proxy service enabling only http")
    public void testPassThroughProxy() throws Exception {

        OMElement response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("enableHttpPassthroughProxy"), null, "WSO2");
