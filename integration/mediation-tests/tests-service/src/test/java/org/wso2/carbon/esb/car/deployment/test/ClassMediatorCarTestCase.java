...
public class ClassMediatorCarTestCase extends ESBIntegrationTest {
    ...
    protected void uploadCar1Test() throws Exception {
        ...
        carbonAppUploaderClient = new CarbonAppUploaderClient(context.getContextUrls().getBackEndUrl(),
                getSessionCookie());
        carbonAppUploaderClient.uploadCarbonAppArtifact(car1FileName, new DataHandler(new FileDataSource(
                new File(getESBResourceLocation() + File.separator + "car" + File.separator + car1FileName))));
    ...
    public void capp1DeploymentAndServiceInvocation() throws Exception {
        ...
        try {
            response = axis2Client.sendCustomQuoteRequest(getProxyServiceURLHttp(proxyName), null, "WSO2");
    ...
    public void capp1UnDeploymentTest() throws Exception {
        ...
        TimeUnit.SECONDS.sleep(5);
        Assert.assertTrue(
                esbUtils.isProxyUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(), proxyName),
    ...
    protected void uploadCar2Test() throws Exception {
        ...
        carbonAppUploaderClient.
                uploadCarbonAppArtifact(car2FileName, new DataHandler(new FileDataSource(
                        new File(getESBResourceLocation() + File.separator + "car" + File.separator + car2FileName))));
    ...
    public void capp2DeploymentAndServiceInvocation() throws Exception {
        ...
        Assert.assertNotNull(response, "Response message null");
        Assert.assertTrue(response.toString().contains("MEDIATOR2"), "MEDIATOR2 element not found in response message");
