...
public class CarbonApplicationDeploymentTestCase extends ESBIntegrationTest {
    ...
    public void endpointDeploymentTest() throws Exception {
        ...
        Assert.assertTrue(esbUtils.isEndpointDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "loadBalanceEndpoint"), "LoadBalanceEndpoint Endpoint deployment failed");
        Assert.assertTrue(esbUtils.isEndpointDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "wsdlEndpoint"), "WSDLEndpoint Endpoint deployment failed");
        Assert.assertTrue(esbUtils.isEndpointDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "failOverEndpoint"), "FailOverEndpoint Endpoint deployment failed");
        Assert.assertTrue(esbUtils.isEndpointDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
    ...
    public void sequenceDeploymentTest() throws Exception {
        ...
        Assert.assertTrue(esbUtils.isSequenceDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleFaultSequence"), "sampleFaultSequence deployment failed");
        Assert.assertTrue(esbUtils.isSequenceDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleSequenceWithErrorSequence"), "sampleSequenceWithErrorSequence deployment failed");
    ...
    public void proxyServiceDeploymentTest() throws Exception {
        ...
        Assert.assertTrue(esbUtils.isProxyDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "transformProxySample"), "transform Proxy service deployment failed");
        Assert.assertTrue(esbUtils.isProxyDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleCustomProxy"), "Custom Proxy service deployment failed");
    ...
    private void verifyUndeployment() throws Exception {
        Assert.assertTrue(esbUtils.isEndpointUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "addressEndpoint"), "AddressEndpoint Endpoint Undeployment failed");
        Assert.assertTrue(esbUtils.isEndpointUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "loadBalanceEndpoint"), "LoadBalanceEndpoint Endpoint Undeployment failed");
        Assert.assertTrue(esbUtils.isEndpointUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "wsdlEndpoint"), "WSDLEndpoint Endpoint Undeployment failed");
        Assert.assertTrue(esbUtils.isEndpointUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "failOverEndpoint"), "FailOverEndpoint Endpoint Undeployment failed");
        Assert.assertTrue(esbUtils.isEndpointUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "defaultEndpoint"), "DefaultEndpoint Endpoint Undeployment failed");

        Assert.assertTrue(esbUtils.isSequenceUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleSequence"), "sampleSequence Undeployment failed");
        Assert.assertTrue(esbUtils.isSequenceUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleFaultSequence"), "sampleFaultSequence Undeployment failed");
        Assert.assertTrue(esbUtils.isSequenceUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleSequenceWithErrorSequence"), "sampleSequenceWithErrorSequence Undeployment failed");

        Assert.assertTrue(
                esbUtils.isApiUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(), "SampleAPI"),
                "SampleAPI Undeployment failed");

        Assert.assertTrue(esbUtils.isLocalEntryUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleInLineXMLLocalentry"), "InLine XML Local entry Undeployment failed");
        Assert.assertTrue(esbUtils.isLocalEntryUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleURLLocalEntry"), "URL Local Entry Undeployment failed");
        Assert.assertTrue(esbUtils.isLocalEntryUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleInLineTextLocalEntry"), "InLine text Local Entry Undeployment failed");

        Assert.assertTrue(esbUtils.isProxyUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "samplePassThroughProxy"), "Pass Through Proxy service Undeployment failed");
        Assert.assertTrue(esbUtils.isProxyUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "transformProxySample"), "transform Proxy service Undeployment failed");
        Assert.assertTrue(esbUtils.isProxyUnDeployed(context.getContextUrls().getBackEndUrl(), getSessionCookie(),
                "sampleCustomProxy"), "Custom Proxy service Undeployment failed");
    }
}
