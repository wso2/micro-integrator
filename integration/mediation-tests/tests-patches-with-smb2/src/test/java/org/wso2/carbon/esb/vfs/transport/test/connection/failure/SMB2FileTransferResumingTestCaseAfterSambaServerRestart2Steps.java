 ...
 */
public class SMB2FileTransferResumingTestCaseAfterSambaServerRestart2Steps extends ESBIntegrationTest {

    private static final Log LOGGER = LogFactory.getLog(SMB2FileTransferResumingTestCaseAfterSambaServerRestart2Steps.class);
    ...
    @Test(groups = "wso2.esb", description = "SMB2 file transfer resuming test after server restarts in 2 steps")
    public void fileTransferResumingTestAfterSambaServerRestart2Steps()
        ...
        // is 5,this waiting period should suffice. But it may include the time it take to deploy the service as well.
     ...
     * Check whether all the files have been copied from in to out
     * */
    private Callable<Boolean> checkWhetherPollingFinished(final File inputFolder) {
        return new Callable<Boolean>() {
            @Override
            public Boolean call() {
