...
@XmlRootElement(name = "PaymentStatus") public class PaymentStatus {
     ...
     */
    @XmlElement(name = "Status", required = true) private String status;
     ...
     * }
     */
    @XmlElement(name = "Payment", required = true) private Payment payment;
