...
public class JSONArrayTestCase extends ESBIntegrationTest {
    ...
    public void testXMLToJSONArray() throws Exception {
        ...
        String xmlPayload = "<StockQuotes>" + " <Stock> " + "<Symbol>IBM</Symbol> " + "<Last>0.00</Last> "
                ...
                + "<High>N/A</High> " + "<Low>N/A</Low> " + "<Volume>N/A</Volume> " + "<MktCap>N/A</MktCap> "
                + "<PreviousClose>N/A</PreviousClose> " + "<PercentageChange>N/A</PercentageChange> "
                + "<AnnRange>N/A - N/A</AnnRange> " + "<Earns>N/A</Earns> " + "<P-E>N/A</P-E> " + "<Name>IBM</Name> "
                + "</Stock> " + "<Stock> " + "<Symbol>WSO2</Symbol> " + "<Last>0.00</Last> "
                + "<Date>15/12/2015</Date> " + "<Time>N/A</Time> " + "<Change>N/A</Change> " + "<Open>N/A</Open> "
                + "<High>N/A</High> " + "<Low>N/A</Low> " + "<Volume>N/A</Volume> " + "<MktCap>N/A</MktCap> "
                + "<PreviousClose>N/A</PreviousClose> " + "<PercentageChange>N/A</PercentageChange> "
                + "<AnnRange>N/A - N/A</AnnRange> " + "<Earns>N/A</Earns> " + "<P-E>N/A</P-E> " + "<Name>WSO2</Name> "
                + "</Stock> " + "</StockQuotes>";
