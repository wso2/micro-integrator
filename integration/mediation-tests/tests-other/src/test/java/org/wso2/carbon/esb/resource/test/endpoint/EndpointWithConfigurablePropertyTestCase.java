...
public class EndpointWithConfigurablePropertyTestCase extends ESBIntegrationTest {
    ...
    public void testConfigurablePropertyWithSystemProperty() throws IOException, AutomationUtilException {
        File fileProperty = new File(CarbonBaseUtils.getCarbonHome() + File.separator +
                "conf" + File.separator + "file.properties");
        Assert.assertTrue(fileProperty.exists() && !fileProperty.isDirectory());
        Assert.assertTrue(fileProperty.delete());
