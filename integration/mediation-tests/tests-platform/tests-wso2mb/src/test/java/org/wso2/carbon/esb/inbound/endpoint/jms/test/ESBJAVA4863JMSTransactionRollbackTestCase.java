    ...
    public void init() throws Exception {
        ...
        loadESBConfigurationFromClasspath(
                "artifacts" + File.separator + "ESB" + File.separator + "synapseconfig" + File.separator
                        + "ESBJAVA4863synapseconfig.xml");
        OMElement playGroundInboundEp = esbUtils.loadResource(
                "artifacts" + File.separator + "ESB" + File.separator + "synapseconfig" + File.separator
                        + "ESBJAVA4863playground-inbound.xml");

        OMElement jmsInboundEp = esbUtils.loadResource(
                "artifacts" + File.separator + "ESB" + File.separator + "synapseconfig" + File.separator
                        + "ESBJAVA4863jmsinbound.xml");
