...
public class SwitchingBasedOnAddressTestCase extends ESBIntegrationTest {
    ...
    public void testSample2() throws RemoteException, XPathExpressionException {
        ...
        response = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("switchMediatorSwitchByAddressTestProxy"),
        ...
        response = axis2Client.sendSimpleQuoteRequest(getProxyServiceURLHttp("switchMediatorSwitchByAddressTestProxy"),
                getBackEndServiceUrl(ESBTestConstant.SIMPLE_STOCK_QUOTE_SERVICE), "MSTF");
        assertEquals("getSimpleQuote Response root element name mismatched", "getSimpleQuoteResponse",
