...
public class RespondIntegrationTest extends ESBIntegrationTest {
    ...
    public void testRespondMediator() throws AxisFault {
        ...
        stockQuoteResponse1 = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("respondMediatorTestProxy"), null, "WSO2");

        assertNotNull(stockQuoteResponse1, "Response is null");

        assertEquals(stockQuoteResponse1.getFirstElement()
                        .getFirstChildWithName(new QName("http://services.samples/xsd", "symbol")).getText(), "WSO2",
                "Symbol does not match");

        // Checking Respond mediator
        stockQuoteResponse2 = axis2Client
                .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("respondMediatorTestProxy"), null, "IBM");
        ...
        assertEquals(stockQuoteResponse2.getFirstElement()
                        .getFirstChildWithName(new QName("http://services.samples", "symbol")).getText(), "IBM",
                "Symbol does not match");

        try {
            stockQuoteResponse3 = axis2Client
                    .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("respondMediatorTestProxy"), null, "MSFT");
