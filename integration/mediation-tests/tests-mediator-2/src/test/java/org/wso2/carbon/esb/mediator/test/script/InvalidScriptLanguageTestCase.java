...
public class InvalidScriptLanguageTestCase extends ESBIntegrationTest {
    ...
    public void testSequenceJSMediatorWithInvalidScriptLanguage() throws Exception {
        boolean deployed = checkProxyServiceExistence("InvalidScriptLanguageTestProxy");
        Assert.assertFalse(deployed, "This Configuration can not be saved successfully due to invalid Script " +
                "language");
