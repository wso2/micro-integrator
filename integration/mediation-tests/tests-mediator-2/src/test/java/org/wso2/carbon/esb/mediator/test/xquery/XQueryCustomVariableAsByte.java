...
public class XQueryCustomVariableAsByte extends ESBIntegrationTest {
    ...
    public void testXQueryTransformationWithByteValue() throws AxisFault {
        ...
        response = getQuoteCustomRequest
                .sendReceive(getProxyServiceURLHttp("xQueryCustomVariableAsByteTestProxy"), "WSO2");
        assertNotNull(response, "Response message null");
        assertEquals(response.getFirstElement()
                        .getFirstChildWithName(new QName("http://services.samples/xsd", "symbol", "ax21")).getText(), "100",
