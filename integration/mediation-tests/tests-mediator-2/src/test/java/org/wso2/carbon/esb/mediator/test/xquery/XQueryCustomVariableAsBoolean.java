...
public class XQueryCustomVariableAsBoolean extends ESBIntegrationTest {
    ...
    public void testXQueryTransformationWithBooleanValue() throws AxisFault {
        ...
        response = getQuoteCustomRequest
                .sendReceive(getProxyServiceURLHttp("xQueryCustomVariableAsBooleanTestProxy"), "WSO2");
        assertNotNull(response, "Response message null");
        assertEquals(response.getFirstElement()
                        .getFirstChildWithName(new QName("http://services.samples/xsd", "symbol", "ax21")).getText(), "true",
