...
cd %CARBON_HOME%
set CARBON_CLASSPATH="%CARBON_HOME%\bin\*"
set CARBON_CLASSPATH="%JAVA_HOME%\lib\tools.jar";%CARBON_CLASSPATH%
set CARBON_CLASSPATH=%CARBON_CLASSPATH%;"%CARBON_HOME%\wso2\lib\*"
