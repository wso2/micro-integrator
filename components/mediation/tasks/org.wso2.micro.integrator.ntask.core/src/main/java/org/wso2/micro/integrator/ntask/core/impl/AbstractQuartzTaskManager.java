...
public abstract class AbstractQuartzTaskManager implements org.wso2.micro.integrator.ntask.core.TaskManager {
    ...
    public AbstractQuartzTaskManager(org.wso2.micro.integrator.ntask.core.TaskRepository taskRepository) throws TaskException {
    ...
    protected synchronized boolean deleteLocalTask(String taskName, 
        ...
        try {
            ...
            if (result) {
                ...
                org.wso2.micro.integrator.ntask.core.impl.LocalTaskActionListener listener = localTaskActionListeners.get(taskName);
                if (null != listener) {
    ...
    protected synchronized void scheduleLocalTask(String taskName) throws TaskException {
        boolean paused = org.wso2.micro.integrator.ntask.core.TaskUtils.isTaskPaused(this.getTaskRepository(), taskName);
    ...
    protected List<org.wso2.micro.integrator.ntask.core.TaskInfo> getAllFinishedTasks() throws TaskException {
        List<org.wso2.micro.integrator.ntask.core.TaskInfo> tasks = this.getTaskRepository().getAllTasks();
        List<org.wso2.micro.integrator.ntask.core.TaskInfo> result = new ArrayList<org.wso2.micro.integrator.ntask.core.TaskInfo>();
        for (org.wso2.micro.integrator.ntask.core.TaskInfo taskInfo : tasks) {
            if (org.wso2.micro.integrator.ntask.core.TaskUtils.isTaskFinished(this.getTaskRepository(), taskInfo.getName())) {
                result.add(taskInfo);
            }
        }
        return result;
    ...
    private CronScheduleBuilder getCronScheduleBuilder(org.wso2.micro.integrator.ntask.core.TaskInfo.TriggerInfo triggerInfo)
    ...
    private SimpleScheduleBuilder getSimpleScheduleBuilder(org.wso2.micro.integrator.ntask.core.TaskInfo.TriggerInfo triggerInfo)
            throws TaskException {
