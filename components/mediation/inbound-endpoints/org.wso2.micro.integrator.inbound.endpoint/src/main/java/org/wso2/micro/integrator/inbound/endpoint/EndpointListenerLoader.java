 ...
 */
package org.wso2.micro.integrator.inbound.endpoint;
...
import org.wso2.micro.integrator.inbound.endpoint.persistence.service.InboundEndpointPersistenceServiceDSComponent;
...
import org.wso2.micro.integrator.inbound.endpoint.protocol.websocket.management.WebsocketEndpointManager;
...
public class EndpointListenerLoader {
        ...
        for (Map.Entry tenantInfoEntry : tenantData.entrySet()) {
            ...
            if (inboundEndpointInfoDTO.getProtocol().equals(
                ...
                HTTPEndpointManager.getInstance().
                    ...
                    InboundRequestProcessorFactoryImpl.Protocols.ws.toString())) {
                WebsocketEndpointManager.getInstance().
                        startListener(port, inboundEndpointInfoDTO.getEndpointName(),
                                inboundEndpointInfoDTO.getInboundParams());
            } else if (inboundEndpointInfoDTO.getProtocol().equals(
                    InboundRequestProcessorFactoryImpl.Protocols.wss.toString())) {
                WebsocketEndpointManager.getInstance().
                        startSSLListener(port, inboundEndpointInfoDTO.getEndpointName(),
                                inboundEndpointInfoDTO.getInboundParams());
                ...
                if (GenericInboundListener
                        .isListeningInboundEndpoint(inboundParams)) {
    ...
    private static void loadInternalInboundApis() {
        ...
        HTTPEndpointManager manager = HTTPEndpointManager
                .getInstance();
