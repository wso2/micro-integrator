 ...
 */
@Component(name = "org.wso2.micro.integrator.initializer.StartupFinalizerServiceComponent", immediate = true)
...
//        System.getProperties().remove(CarbonConstants.START_TIME);
  ...
  /*  @Reference(
            name = "org.wso2.micro.integrator.core.deployment.DeploymentService",
            service = org.wso2.micro.integrator.core.deployment.DeploymentService.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
