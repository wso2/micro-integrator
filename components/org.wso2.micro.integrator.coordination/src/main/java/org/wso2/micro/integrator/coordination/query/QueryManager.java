...
public class QueryManager {
    private final Map<DBQueries, String> mysqlQueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.CREATE_LEADER_STATUS_TABLE, "CREATE TABLE LEADER_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID))");
                put(DBQueries.CREATE_CLUSTER_NODE_STATUS_TABLE, "CREATE TABLE CLUSTER_NODE_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL,IS_NEW_NODE INT NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID,NODE_ID))");
                put(DBQueries.CREATE_MEMBERSHIP_EVENT_TABLE, "CREATE TABLE MEMBERSHIP_EVENT_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, CHANGE_TYPE INT NOT NULL, CHANGED_MEMBER_ID VARCHAR(512) NOT NULL)");
                put(DBQueries.CREATE_REMOVED_MEMBERS_TABLE, "CREATE TABLE REMOVED_MEMBERS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL, REMOVED_MEMBER_ID VARCHAR(512) NOT NULL)");

                put(DBQueries.INSERT_COORDINATOR_ROW, "INSERT INTO LEADER_STATUS_TABLE (GROUP_ID, NODE_ID, LAST_HEARTBEAT) VALUES (?,?,?)");
                put(DBQueries.INSERT_NODE_HEARTBEAT_ROW, "INSERT INTO CLUSTER_NODE_STATUS_TABLE (NODE_ID, LAST_HEARTBEAT, GROUP_ID, PROPERTY_MAP, IS_NEW_NODE) VALUES (?,?,?,?,1)");
                ...
                put(DBQueries.INSERT_REMOVED_MEMBER_DETAILS, "INSERT INTO REMOVED_MEMBERS_TABLE (NODE_ID, GROUP_ID, REMOVED_MEMBER_ID, PROPERTY_MAP) VALUES ( ?,?,?,?)");

                put(DBQueries.UPDATE_PROPERTIES_MAP, "UPDATE CLUSTER_NODE_STATUS_TABLE SET PROPERTY_MAP =? WHERE NODE_ID =? AND GROUP_ID =?");
                ...
                put(DBQueries.SELECT_REMOVED_MEMBER_DETAILS, "SELECT REMOVED_MEMBER_ID, PROPERTY_MAP, GROUP_ID FROM REMOVED_MEMBERS_TABLE WHERE NODE_ID =? AND REMOVED_MEMBER_ID =? AND GROUP_ID =?");

                put(DBQueries.GET_COORDINATOR_NODE_ID, "SELECT NODE_ID FROM LEADER_STATUS_TABLE WHERE GROUP_ID =?");
                put(DBQueries.GET_COORDINATOR_NODE, "SELECT PROPERTY_MAP FROM CLUSTER_NODE_STATUS_TABLE WHERE GROUP_ID =? AND NODE_ID =?");
                ...
                put(DBQueries.GET_ALL_NODE_HEARTBEAT, "SELECT GROUP_ID, NODE_ID, PROPERTY_MAP, LAST_HEARTBEAT, IS_NEW_NODE FROM CLUSTER_NODE_STATUS_TABLE WHERE GROUP_ID=?");
                put(DBQueries.GET_NODE_DATA, "SELECT GROUP_ID, NODE_ID, PROPERTY_MAP, LAST_HEARTBEAT, IS_NEW_NODE FROM CLUSTER_NODE_STATUS_TABLE WHERE GROUP_ID=? AND NODE_ID=?");
    ...
    private final Map<DBQueries, String> postgreSQLQueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.CREATE_LEADER_STATUS_TABLE, "CREATE TABLE LEADER_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID))");
                put(DBQueries.CREATE_CLUSTER_NODE_STATUS_TABLE, "CREATE TABLE CLUSTER_NODE_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BIGINT NOT NULL,IS_NEW_NODE INT NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID,NODE_ID))");
                put(DBQueries.CREATE_MEMBERSHIP_EVENT_TABLE, "CREATE TABLE MEMBERSHIP_EVENT_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, CHANGE_TYPE INT NOT NULL, CHANGED_MEMBER_ID VARCHAR(512) NOT NULL)");
                put(DBQueries.CREATE_REMOVED_MEMBERS_TABLE, "CREATE TABLE REMOVED_MEMBERS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BIGINT NOT NULL, REMOVED_MEMBER_ID VARCHAR(512) NOT NULL)");
    ...
    private final Map<DBQueries, String> microsoftSQLServerQueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.CREATE_LEADER_STATUS_TABLE, "CREATE TABLE LEADER_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID))");
                put(DBQueries.CREATE_CLUSTER_NODE_STATUS_TABLE, "CREATE TABLE CLUSTER_NODE_STATUS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP VARBINARY(8000) NOT NULL,IS_NEW_NODE INT NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID,NODE_ID))");
                put(DBQueries.CREATE_MEMBERSHIP_EVENT_TABLE, "CREATE TABLE MEMBERSHIP_EVENT_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, CHANGE_TYPE INT NOT NULL, CHANGED_MEMBER_ID VARCHAR(512) NOT NULL)");
                put(DBQueries.CREATE_REMOVED_MEMBERS_TABLE, "CREATE TABLE REMOVED_MEMBERS_TABLE (GROUP_ID VARCHAR(512) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP VARBINARY(8000) NOT NULL, REMOVED_MEMBER_ID VARCHAR(512) NOT NULL)");
    ...
    private final Map<DBQueries, String> oracleQueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.CREATE_LEADER_STATUS_TABLE, "CREATE TABLE LEADER_STATUS_TABLE (GROUP_ID VARCHAR2(512) NOT NULL, NODE_ID VARCHAR2(512) NOT NULL, LAST_HEARTBEAT NUMBER NOT NULL, PRIMARY KEY (GROUP_ID))");
                put(DBQueries.CREATE_CLUSTER_NODE_STATUS_TABLE, "CREATE TABLE CLUSTER_NODE_STATUS_TABLE (GROUP_ID VARCHAR2(512) NOT NULL, NODE_ID VARCHAR2(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL,IS_NEW_NODE INT NOT NULL, LAST_HEARTBEAT NUMBER NOT NULL, PRIMARY KEY (GROUP_ID,NODE_ID))");
                put(DBQueries.CREATE_MEMBERSHIP_EVENT_TABLE, "CREATE TABLE MEMBERSHIP_EVENT_TABLE (GROUP_ID VARCHAR2(512) NOT NULL, NODE_ID VARCHAR2(512) NOT NULL, CHANGE_TYPE INT NOT NULL, CHANGED_MEMBER_ID VARCHAR2(512) NOT NULL)");
                put(DBQueries.CREATE_REMOVED_MEMBERS_TABLE, "CREATE TABLE REMOVED_MEMBERS_TABLE (GROUP_ID VARCHAR2(512) NOT NULL, NODE_ID VARCHAR2(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL, REMOVED_MEMBER_ID VARCHAR2(512) NOT NULL)");
    ...
    private final Map<DBQueries, String> db2QueryMap =
            Collections.unmodifiableMap(new HashMap<DBQueries, String>() {{
                ...
                put(DBQueries.CREATE_LEADER_STATUS_TABLE, "CREATE TABLE LEADER_STATUS_TABLE (GROUP_ID VARCHAR(508) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID))");
                put(DBQueries.CREATE_CLUSTER_NODE_STATUS_TABLE, "CREATE TABLE CLUSTER_NODE_STATUS_TABLE (GROUP_ID VARCHAR(508) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL,IS_NEW_NODE INT NOT NULL, LAST_HEARTBEAT BIGINT NOT NULL, PRIMARY KEY (GROUP_ID,NODE_ID))");
                put(DBQueries.CREATE_MEMBERSHIP_EVENT_TABLE, "CREATE TABLE MEMBERSHIP_EVENT_TABLE (GROUP_ID VARCHAR(508) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, CHANGE_TYPE INT NOT NULL, CHANGED_MEMBER_ID VARCHAR(512) NOT NULL)");
                put(DBQueries.CREATE_REMOVED_MEMBERS_TABLE, "CREATE TABLE REMOVED_MEMBERS_TABLE (GROUP_ID VARCHAR(508) NOT NULL, NODE_ID VARCHAR(512) NOT NULL, PROPERTY_MAP BLOB NOT NULL, REMOVED_MEMBER_ID VARCHAR(512) NOT NULL)");
