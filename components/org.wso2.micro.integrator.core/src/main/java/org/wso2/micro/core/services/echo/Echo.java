...
package org.wso2.micro.core.services.echo;
...
public class Echo {
    ...
    public org.wso2.micro.core.services.echo.SimpleBean echoStringArrays(String[] a, String[] b, int c) {
//
        org.wso2.micro.core.services.echo.SimpleBean bean = new SimpleBean();
        bean.setA_r(a);
        bean.setB_r(b);
        bean.setC(c);
