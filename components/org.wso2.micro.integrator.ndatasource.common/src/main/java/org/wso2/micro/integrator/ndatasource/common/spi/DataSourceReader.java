 ...
 * under the License.
 */
package org.wso2.micro.integrator.ndatasource.common.spi;

import org.wso2.micro.integrator.ndatasource.common.DataSourceException;

/**
 * This represents the service provider interface that must be implemented by any of the data source type
 * implementations.
 */
