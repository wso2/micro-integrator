...
public class ExpressionVisitorImpl implements ExpressionVisitor<VisitorOperand> {
    ...
    @Override
    public VisitorOperand visitBinaryOperator(BinaryOperatorKind binaryOperatorKind, VisitorOperand visitorOperand, List<VisitorOperand> list) throws ExpressionVisitException, ODataApplicationException {
        return throwNotImplemented();
    }
