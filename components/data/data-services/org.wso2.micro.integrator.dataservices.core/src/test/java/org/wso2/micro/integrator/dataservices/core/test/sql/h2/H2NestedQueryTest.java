...
public class H2NestedQueryTest extends AbstractNestedQueryServiceTest {

	public H2NestedQueryTest(String testName) {
		super(testName, "H2NestedQueryStoredProcService");
	}
	
	public void testH2NestedQuery1() {
		this.nestedQuery1();
	}
	
    public void testH2NestedQuery2() {
    	this.nestedQuery2();
	}
